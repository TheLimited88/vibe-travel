    ...
    <div style={{ display: 'flex', justifyContent: 'center', minHeight: '100vh', background: '#FFFFFF', paddingTop: '20px' }}>
      <div style={{ width: '100%', maxWidth: '335px' }}>
        ...
        <div style={{ display: 'flex', gap: '40px', marginBottom: '28px', borderBottom: '1px solid rgba(0,0,0,0.08)', paddingBottom: '12px' }}>
          ...
          <Link href="/auth/create-account" style={{ fontSize: '16px', fontWeight: '400', color: 'rgba(0,0,0,0.4)', textDecoration: 'none' }}>
            Create account
          </Link>
        </div>
        ...
        <div style={{ marginBottom: '20px', textAlign: 'right' }}>
          <Link href="#" style={{ fontSize: '14px', fontWeight: '600', color: '#7F53F3', textDecoration: 'none' }}>
            Forgot password?
          </Link>
        </div>
        ...
        <p style={{ fontSize: '12px', color: 'rgba(0,0,0,0.5)', textAlign: 'center', margin: '16px 0 0', lineHeight: '1.6' }}>
          By signing in you agree to Vibe Travel's <Link href="#" style={{ color: '#7F53F3', textDecoration: 'none' }}>Terms of Service</Link> and <Link href="#" style={{ color: '#7F53F3', textDecoration: 'none' }}>Privacy Policy</Link>.
        </p>
      </div>
    </div>
  );
